"""CSVLENS core — Fast CLI for profiling and cleaning huge CSV / Parquet files."""
...
RULES = [
    ("CSV-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("CSV-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("CSV-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
